...
type BooksAddedChartProps = {
  data: ChartDataPoint[];
};

export const BooksAddedChart = ({ data }: BooksAddedChartProps) => {
  ...
  return (
    <ChartContainer title="Livres ajoutés à la bibliothèque (30 derniers jours)">
