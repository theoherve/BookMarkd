                ...
                <div className="flex gap-3 md:gap-4 min-w-max h-full items-stretch pb-2">
                  {filteredReadList.slice(0, 20).map((item) => (
                    <Link
                      ...
                      className="flex h-full w-40 min-w-40 md:w-48 md:min-w-48 shrink-0 flex-col gap-3 rounded-lg border border-border/50 bg-background/60 p-3 transition hover:border-border hover:shadow-md cursor-pointer"
