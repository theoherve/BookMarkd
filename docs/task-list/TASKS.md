...
- Feed branché sur `/api/feed` (TanStack Query + Zustand pour les filtres).
- Prochaine grosse étape : complétion du schéma Supabase (listes collaboratives, follows avancé) + hooks sur recherche / Open Library.
